...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="md:w-64 w-full bg-white p-2 md:p-5 shadow-sm flex md:flex-col justify-between overflow-x-auto md:overflow-visible flex-shrink-0">
     <div className="flex md:flex-col gap-2 w-full">
     <h2 className="text-lg font-semibold mb-6 hidden md:block">
                Dashboard
     </h2>
    <div className="flex md:flex-col gap-2 md:space-y-2 text-sm w-full overflow-x-auto">
     {[
          ...
          ["account", "Account Details", accountIcon],
           ...
           className={`${menuClass( key )}
        min-w-[120px] md:min-w-full flex items-center justify-between`}>
        <div className="flex items-center gap-2 md:gap-3">
         ...
         <span className="text-[11px] md:text-sm">
           ...
           <img src={chevron}
             className="w-3 opacity-50 hidden md:block" />
                </div>
             ))}
              </div>
            </div>
            ...
            <div onClick={() => handleClick("Logout")}
              className="bg-[#FFF49CFF] p-2 md:p-3 rounded-xl flex justify-center md:justify-between items-center text-black cursor-pointer mt-2 md:mt-4" >
          ...
          <div className="flex-1 w-full p-3 md:p-6">
            <div className="w-full bg-white p-4 md:p-5 rounded-2xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
           ...
           <p className="text-[10px] md:text-sm text-gray-500">
            ...
            <>
           {/* STATS */}
           <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mt-6 w-full">
            {[
     ...
     <div key={i}
       ...
       <img src={chevron} className="w-3" />
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6 mt-6 w-full">
